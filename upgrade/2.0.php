...
return static function (RectorConfig $rectorConfig): void {
    ...
    $rectorConfig->ruleWithConfiguration(RenameClassRector::class, [
        ...
        'PhPhD\ExceptionalValidation\Formatter\ViolationListException' => 'PhPhD\ExceptionalMatcher\Validator\Formatter\Embedded\ViolationsEmbeddedException',
        'PhPhD\ExceptionalValidation\Formatter\ViolationListExceptionFormatter' => 'PhPhD\ExceptionalMatcher\Validator\Formatter\Embedded\ViolationsEmbeddedExceptionFormatter',
    ...
    $rectorConfig->ruleWithConfiguration(RenameMethodRector::class, [
        new MethodCallRename('PhPhD\ExceptionalMatcher\Validator\Formatter\Embedded\ViolationsEmbeddedException', 'getViolationList', 'getViolations'),
        new MethodCallRename('PhPhD\ExceptionalMatcher\Validator\Middleware\ExceptionalValidationFailedException', 'getViolationList', 'getViolations'),
    ]);
};
