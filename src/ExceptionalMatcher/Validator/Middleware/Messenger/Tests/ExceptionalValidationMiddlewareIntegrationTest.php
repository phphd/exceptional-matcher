...
/**
 * @covers \PhPhD\ExceptionalMatcher\Validator\Middleware\Messenger\ExceptionalValidationMiddleware
 * @covers \PhPhD\ExceptionalMatcher\Validator\Middleware\Messenger\ExceptionalValidationFailedMessengerException
 *
 * @internal
 */
